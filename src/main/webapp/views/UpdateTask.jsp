...
<body>
    ...
    <div class="container">
        ...
        <form:form action="/api/task/updateTask" method="POST" modelAttribute="task">
			<form:input path="id" type="hidden"/>
            <div class="row">
            	<div class="form-group col-md-12">
            		<label class="col-md-3" for="taskName">Task</label>
            		<div class="col-md-6">
            ...
            <div class="row">
            	<div class="form-group col-md-12">
            		<label class="col-md-3" for="taskDescription">Description</label>
            		<div class="col-md-6">
            			<form:input type="text" path="taskDescription" id="taskDescription"
            				class="form-control input-sm" required="required" />
            		</div>
            	</div>
            </div>
